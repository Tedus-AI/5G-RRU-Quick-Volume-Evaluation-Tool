...
| **P** | Fin Pitch — center-to-center distance between two adjacent fins (mm) |
| **G** | Fin Gap — clear air space between adjacent fins: G = P − T_root (mm) |
...
def drc_check(H, T_tip, alpha_deg, P, convection="natural", has_cross_ribs=False, N_CR=0, CR_spacing=None):
    ...
    Parameters:
        ...
        P           : Fin pitch, center-to-center (mm)
