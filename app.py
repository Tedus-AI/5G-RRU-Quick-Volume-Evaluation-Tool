...
# ==============================================================================
# 版本：v3.109 (Column Visibility Control)
# 日期：2026-02-09
# 修正重點：
# 1. [Feature] Tab 2 新增「欄位顯示控制器 (Column Filter)」：
#    - 使用 st.multiselect 讓使用者自由勾選/隱藏表格欄位。
#    - 解決表格橫向過長、需頻繁捲動的問題。
# 2. [Logic] 動態樣式應用：
#    - 根據篩選後的 DataFrame 動態套用 background_gradient 與 format。
#    - 加入防呆檢查，確保隱藏關鍵欄位 (如 Allowed_dT) 時不會報錯。
# ==============================================================================
