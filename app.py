...
# ==============================================================================
# 版本：v3.9.2 (Caption & Header Fix)
# 日期：2026-01-29
# 更新：
# 1. Tab 1 註釋改回「滑鼠游標停留查看定義」版本。
# 2. 增加 CSS 強制將表格「標題 (Header)」置中 (內容維持預設對齊以確保編輯功能正常)。
# ==============================================================================
...
<style>
    ...
    /* 強制將所有表格的「標題列 (Headers)」置中 */
    /* 注意：數值內容(Body)仍會靠右，這是 Streamlit 為了對齊小數點的強制設定 */
    [data-testid="stDataFrame"] th {
        text-align: center !important;
    }
    [data-testid="stDataFrame"] .height-name {
